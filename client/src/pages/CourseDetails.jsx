...
function CourseDetails() {
  ...
  return (
    <>
      <div className={`relative w-full bg-gray-800`}>
        ...
        <div className="mx-auto box-content px-4 lg:w-[1260px] 2xl:relative ">
          <div className="mx-auto grid min-h-[450px] max-w-maxContentTab justify-items-center py-8 lg:mx-0 lg:justify-items-start lg:py-0 xl:max-w-[810px]">
            ...
            <div
              className={`z-30 my-5 flex flex-col justify-center gap-4 py-5 text-lg text-gray-200`}
            >
              <div>
                <p className="text-4xl font-bold text-gray-200 sm:text-[42px]">
                  {courseName}
                </p>
              </div>
              <p className={`text-gray-200`}>{courseDescription}</p>
      ...
      <div className="mx-auto box-content px-4 text-start text-gray-200 lg:w-[1260px]">
